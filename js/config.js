...
function changeSOTD() {
  ...
  switch (respecConfig.specStatus) {
    ...
    case "CV":
      tag.innerHTML +=
        "Dit is een door de werkgroep goedgekeurde consultatieversie van het document '" +
        document.title +
        "'. " +
        "Commentaar over dit document kan gestuurd worden naar <a href='" +
        respecConfig.emailComments +
        "'></a>" +
        ".";
      break;
    case "VV":
      tag.innerHTML +=
        "Dit is een definitief concept van de nieuwe versie van het document '" +
        document.title +
        "'. " +
